...
import { WaitlistHeader } from "@/client/components/layout/waitlist-header";
...
function Footer() {
  return (
    <footer className="mt-auto w-full scroll-smooth">
      <div className="mx-auto max-w-7xl overflow-hidden px-6 py-4 sm:py-8 lg:px-8">
        <nav
        ...
        <p className="mt-4 text-center text-xs leading-5 text-gray-500">
          &copy; 2023 Niche. All rights reserved.
        </p>
      </div>
    </footer>
  );
...
const navigation = {
  ...
  social: [
    {
      name: "Instagram",
      href: "https://instagram.com/niche",
    ...
    {
      name: "Tiktok",
      href: "https://www.tiktok.com/@niche",
      icon: (props: SVGProps<SVGSVGElement>) => (
