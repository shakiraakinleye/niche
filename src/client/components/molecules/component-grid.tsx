...
import Tooltip from "@/components/organisms/common/tooltip";
import modalImage from "@/public/logo.png";

import { useDemoModal, BasicModalContent } from "./common/demo-modal";

const modalElements = {
  image: modalImage,
  title: "Niche",
  description:
    "Niche is an opinionated collection of components, hooks, and utilities for your Next.js project.",
};

export default function ComponentGrid() {
  const { DemoModal, setShowDemoModal } = useDemoModal(
    <BasicModalContent modalElements={modalElements} />
  );
  ...
  return (
    <div className="grid grid-cols-1 gap-5 md:grid-cols-3">
      ...
      <Tooltip content="Niche is an opinionated collection of components, hooks, and utilities for your Next.js project.">
